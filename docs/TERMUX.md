# Bun on Termux <div style="display: inline-block; background: url('../assets/Termux.png') center/cover; width: 40px; height: 40px; border-radius: 8px; margin-right: 10px;"></div>
