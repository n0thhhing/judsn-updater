# <img src="../assets/wordmark.svg" alt="Bun" width="75" height="35" style="translate: -4px; vertical-align: -5px;"/>on Termux  <img src="../assets/Termux.svg" alt="Bun on Termux" width="30" height="30" style="border-radius: 20px; padding: 10px; vertical-align: -15px;translate: 30px"/>
