# <img src="../assets/Termux.png" alt="Bun on Termux" width="40" style="border-radius:25px; margin-right: 10px; padding: 10px;"/> <img src="../assets/wordmark.svg" alt="Bun" width="100" style="border-radius:25px; margin-right: 10px; padding: 10px;"/> on Termux
